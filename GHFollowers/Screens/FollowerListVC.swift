...
class FollowerListVC: UIViewController {
    ...
    // These two items pass through the Hash function and are given a unique value.  That's how Diffable Data Source tracks it.  So they need to conform to Hashable. 
